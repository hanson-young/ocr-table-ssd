...
if __name__ == '__main__':
    ...
    for i in range(len(dataset)):
        ...
        ocr_cropped_bbox = 'eval_results/bbox_v2/'+ ran_str + ".png"
        ocr_cropped_heatmap = 'eval_results/heatmap22222_v2/' + ran_str + ".png"
        print(factor)
        final_pts = []
        ...
        for dps in final_pts:
            ...
            cv2.line(src_image, (dps[0, 0], dps[0, 1]), (dps[1, 0], dps[1, 1]), (b, g, r), 2)
            cv2.line(src_image, (dps[1, 0], dps[1, 1]), (dps[2, 0], dps[2, 1]), (b, g, r), 2)
            cv2.line(src_image, (dps[2, 0], dps[2, 1]), (dps[3, 0], dps[3, 1]), (b, g, r), 2)
            cv2.line(src_image, (dps[0, 0], dps[0, 1]), (dps[3, 0], dps[3, 1]), (b, g, r), 2)
